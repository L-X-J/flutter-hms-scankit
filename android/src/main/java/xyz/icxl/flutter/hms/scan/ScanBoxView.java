 ...
 * - date: `2023/6/6`
 */
public class ScanBoxView extends View implements ValueAnimator.AnimatorUpdateListener{
    ...
    private void initAttrs(Context context, AttributeSet attrs){
        ...
        drawableLine = typedArray.getDrawable(R.styleable.ScanBoxView_sbv_scanLineDrawable);
        drawableFrame = typedArray.getDrawable(R.styleable.ScanBoxView_sbv_scanFrameDrawable);

        framePaddingLeft = framePaddingRight = framePaddingTop = framePaddingBottom =
                typedArray.getDimensionPixelSize(R.styleable.ScanBoxView_sbv_framePadding, 0);
        framePaddingLeft = typedArray.getDimensionPixelSize(R.styleable.ScanBoxView_sbv_framePaddingLeft, framePaddingLeft);
        framePaddingRight = typedArray.getDimensionPixelSize(R.styleable.ScanBoxView_sbv_framePaddingRight, framePaddingRight);
        framePaddingTop = typedArray.getDimensionPixelSize(R.styleable.ScanBoxView_sbv_framePaddingTop, framePaddingTop);
        framePaddingBottom = typedArray.getDimensionPixelSize(R.styleable.ScanBoxView_sbv_framePaddingBottom, framePaddingBottom);

        frameWidth = typedArray.getDimensionPixelSize(R.styleable.ScanBoxView_sbv_frameWidth, frameWidth);
        frameHeight = typedArray.getDimensionPixelSize(R.styleable.ScanBoxView_sbv_frameHeight, frameHeight);

        linePaddingLeft = linePaddingRight = linePaddingTop = linePaddingBottom =
                typedArray.getDimensionPixelSize(R.styleable.ScanBoxView_sbv_linePadding, 0);
        linePaddingLeft = typedArray.getDimensionPixelSize(R.styleable.ScanBoxView_sbv_linePaddingLeft, linePaddingLeft);
        linePaddingRight = typedArray.getDimensionPixelSize(R.styleable.ScanBoxView_sbv_linePaddingRight, linePaddingRight);
        linePaddingBottom = typedArray.getDimensionPixelSize(R.styleable.ScanBoxView_sbv_linePaddingBottom, linePaddingBottom);
        linePaddingTop = typedArray.getDimensionPixelSize(R.styleable.ScanBoxView_sbv_linePaddingTop, linePaddingTop);

        lineWidth = typedArray.getDimensionPixelSize(R.styleable.ScanBoxView_sbv_lineWidth, lineWidth);

        TypedValue typedValueLineHeight = typedArray.peekValue(R.styleable.ScanBoxView_sbv_lineHeight);
        if(typedValueLineHeight.type == TypedValue.TYPE_FLOAT){
            ...
            lineHeight = typedArray.getDimensionPixelSize(R.styleable.ScanBoxView_sbv_lineHeight, 0);
        }

        duration = typedArray.getInt(R.styleable.ScanBoxView_sbv_duration, duration);

        int dimBorderColor = typedArray.getColor(R.styleable.ScanBoxView_sbv_dim_border, Color.TRANSPARENT);
        typedArray.recycle();
